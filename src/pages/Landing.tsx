...
export const Landing = () => {
  ...
  const features = [
    {
      ...
      benefits: ["Electronic Health Records", "Visit History Tracking", "Secure Data Storage"]
    },
    {
      ...
      benefits: ["Live Token Tracking", "Automated Flow Control", "Waiting Time Prediction"]
    },
    {
      ...
      benefits: ["Expiry Date Monitoring", "Low Stock Alerts", "Automated Reordering"]
    },
    {
      ...
      benefits: ["Instant Invoice Generation", "Integrated Payments", "Financial Reporting"]
    }
  ];
  ...
  return (
    <div className="bg-white font-sans text-slate-900 overflow-hidden h-screen scroll-container selection:bg-emerald-100 selection:text-emerald-900">
      ...
      {/* Hero Section */}
      <section className="snap-section h-screen relative flex items-center overflow-hidden" data-index="0">
        <video 
          autoPlay 
          muted 
          loop 
        ...
        <div className="relative z-30 container mx-auto px-8 lg:px-24">
          <div className="max-w-2xl space-y-8">
            <div className="animate-in flex items-center gap-3">
              <div className="w-10 h-10 bg-emerald-600 rounded-xl flex items-center justify-center text-white shadow-lg">
                <Activity className="h-6 w-6" />
              </div>
              <span className="text-xl font-black tracking-tight text-slate-900">Medicare<span className="text-emerald-600">Pro</span></span>
            </div>
            ...
            <p className="animate-in text-xl text-slate-600 font-medium max-w-lg leading-relaxed">
              The professional-grade management system for modern medical practices. 
              Efficiency, security, and precision at every step.
            </p>
            ...
            <div className="animate-in flex items-center gap-6 pt-4">
              ...
              <div className="flex flex-col">
                 ...
                 <span className="text-sm font-black text-slate-900">50+ Clinics Islandwide</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-10 reveal-content">
              <div className="space-y-4">
                ...
                <h2 className="text-5xl font-black tracking-tight text-slate-900">{feature.title}</h2>
              </div>
            ...
            <div className="hidden lg:flex justify-end reveal-visual">
               <div className="w-full aspect-square max-w-lg bg-slate-50 rounded-[3rem] border border-slate-100 flex items-center justify-center relative overflow-hidden group">
                  ...
                  <div className="text-slate-200 group-hover:text-emerald-500 transition-colors duration-500 scale-150 transform group-hover:scale-125">
                     {React.cloneElement(feature.icon as React.ReactElement<any>, { className: 'h-48 w-48' })}
                  </div>
               </div>
            </div>
          </div>
      ...
      {/* Final CTA */}
      <section className="snap-section h-screen flex items-center justify-center text-center px-8 relative bg-slate-900" data-index="5">
        <div className="space-y-12 max-w-4xl relative z-10">
          ...
          <p className="text-xl text-slate-400 font-medium max-w-2xl mx-auto leading-relaxed">
            Join the modern healthcare movement. Secure your clinic's future with Medicare Pro today.
          </p>
          <div className="pt-8">
            <Button 
              size="lg" 
            ...
            <div className="mt-8 flex items-center justify-center gap-6 text-slate-500 text-xs font-black uppercase tracking-widest">
               <span className="flex items-center gap-2"><Shield className="h-4 w-4" /> Secure SSL</span>
               <span className="flex items-center gap-2"><Activity className="h-4 w-4" /> 24/7 Support</span>
            </div>
          </div>
        </div>
      </section>
